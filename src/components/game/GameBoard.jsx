// src/components/game/GameBoard.jsx - COMPLETE FIXED VERSION with stability improvements
...
const GameBoard = ({ setScore, gameStarted, startWithBomb, onGameEnd }) => {
  ...
  }, [gameStarted, startWithBomb, playBomb, updateBoardSafely]);
  ...
  const processMatches = useCallback(async () => {
    ...
    try {
      ...
      while (cascadeCount < MAX_CASCADES) {
        ...
        // Update board safely
        updateBoardSafely(currentBoard.map(row => [...row]));
  ...
  }, [setScore, bombPositions, triggerBombExplosion, playMatch, playScoreUpdate, updateBoardSafely]);
  ...
  }, [bombPositions, isProcessing, triggerBombExplosion, processMatches, updateBoardSafely]);
  ...
  // 🔧 FIXED: Handle drag end with stability improvements
