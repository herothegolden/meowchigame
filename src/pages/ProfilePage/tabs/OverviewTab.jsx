      ...
      {lifeStats.map((stat, i) => (
        <motion.div
          ...
          className={`rounded-2xl border border-white/10 bg-gradient-to-br ${stat.gradient}
                      backdrop-blur-md p-5 h-[155px] flex flex-col justify-center items-center text-center`}
        >
          <div className="flex flex-col items-center justify-center space-y-1 max-w-[90%]">
            <p className="text-[14px] font-medium text-gray-200 tracking-wide">
              {stat.title}
            </p>
