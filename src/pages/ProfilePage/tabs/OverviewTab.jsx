  ...
  return (
    ...
    >
      {lifeStats.map((stat, i) => (
        ...
        >
          <p className="text-[15px] font-semibold text-white/90 mb-3">
            {stat.emoji} {stat.title}
          </p>
          <p className="text-[60px] font-extrabold text-white leading-none mb-3">
            {stat.value}
          </p>
      ...
      >
        ...
        <motion.p
          ...
          className="text-[60px] font-extrabold text-white leading-none mb-3"
        >
          {meowCount}
        </motion.p>
        <p className="text-[13px] text-[#AEB4BE] max-w-[90%]">
