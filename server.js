...
// Placeholder API endpoints (will return mock data for now)
app.post('/api/user/register', (req, res) => {
  res.json({ 
    message: "Database not connected yet", 
    user: { id: 1, telegram_id: req.body.telegram_id, display_name: "Demo User" }
  });
});

app.post('/api/game/complete', (req, res) => {
  res.json({ 
    message: "Game saved (demo mode)", 
    user_needs_profile: false 
  });
});
